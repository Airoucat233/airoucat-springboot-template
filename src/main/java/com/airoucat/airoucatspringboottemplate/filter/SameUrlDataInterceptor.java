...
import com.airoucat.airoucatspringboottemplate.aop.annotation.RepeatSubmit;
import com.airoucat.airoucatspringboottemplate.global.GlobalParams;
import com.airoucat.airoucatspringboottemplate.utils.HttpHelper;
...
//    private String header;
    ...
    public boolean isRepeatSubmit(HttpServletRequest request, RepeatSubmit annotation)
    {
        ...
        // 唯一标识（指定key + url + 消息头）
        String cacheRepeatKey = GlobalParams.REPEAT_SUBMIT_KEY + url + submitKey;
