...
//            return false;
//        }
//        LoginInfo info = CurrentUserContextHolder.getCurrentLoginInfo();
//        if (StringUtils.isNull(info) || CollectionUtils.isEmpty(info.getPermissions()))
//        {
//            return false;
//        }
//        Set<String> authorities = info.getPermissions();
